...
insert into tb_produto (nome, valor, quantidade, validade, categoria_id) values ("Fraldinha", 50, 100, "14/03", 1);
insert into tb_produto (nome, valor, quantidade, validade, categoria_id) values ("Coxão mole", 20, 100, "14/03", 3);
insert into tb_produto (nome, valor, quantidade, validade, categoria_id) values ("Contrafilé", 30, 100, "14/03", 2);
